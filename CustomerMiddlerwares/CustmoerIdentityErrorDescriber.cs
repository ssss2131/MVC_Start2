...
namespace MVC_Start.CustomerMiddlerwares
{
    public class CustmoerIdentityErrorDescriber:IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = nameof(InvalidEmail), Description = $"邮箱 '{email}' 是无效的." };
        }
